...
config = {
    ...
    'modelParams': {
        ...
        'sensorParams': {
            ...
            #
            'encoders': {
                u'wstday_timeOfDay':     {   'fieldname': u'wstday',
    'name': u'wstday_timeOfDay',
    'timeOfDay': (21, 1),
    'type': 'DateEncoder'},
  u'wstday_dayOfWeek':     {   'dayOfWeek': (21, 1),
    'fieldname': u'wstday',
    'name': u'wstday_dayOfWeek',
    'type': 'DateEncoder'},
  u'wstday_weekend':     {   'fieldname': u'wstday',
    'name': u'wstday_weekend',
    'type': 'DateEncoder',
    'weekend': 21},
  u'Grippe':     {   'clipInput': True,
    'fieldname': u'Grippe',
    'maxval': 100,
    'minval': 0,
    'n': 100,
...
control = {
  ...
  #
  'dataset' : {   u'info': u'RKIGTData',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'rki_gt_faelle',
                            u'source': u'testtt/RKIGTData.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'faelle',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'faelle', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'faelle', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
